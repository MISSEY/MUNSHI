<?php
session_start();
define('DEMO_HOME','http://demos.insbyrah.com');
...
try {
    $dbLink = new PDO('mysql:host=localhost;dbname=munshi', "root", "");
...
try {
     $dbLink = new PDO('mysql:host=localhost;dbname=yourdbname', "root", "");
...
<html>
<head>
<title>Make An OTP System Using PHP - Demo INSBYRAH</title>
	...
	<div class="main_wrapper">
		<div class="inner_wrapper">
			<div class="otp_form">
				...
				<a href="http://www.insbyrah.com/2016/08/make-otp-system-in-php-89.html" class="otp_login_form_button_green">Go Back To Tutorial</a>
				<a href="https://www.facebook.com/Mr.Rahul.Negi/" target="_blank" class="otp_login_form_button_fb">Like Me On Facebook</a>
				<?php }else{?>
					<form class="otp_login_form" action="" method="post">
					<?php if($err):?>
					<p class="otp_app_err"><?php echo $err;?></p>
		...
		<div class="otp_footer">
				<p class="otp _disclaimer">We are not using your email id for any purpose, We are unable to provide you OTP system verification using mobile, because we don't have any Mobile SMS gateway at this moment. </p>
		</div>
	</div>
	<div>
	<div><img src="http://www.insbyrah.com/wp-content/uploads/2016/08/cropped-INSBYRAH_LOGO_NEW.png" width="200"></div>
	<h2>Thanks to request an OTP</h2> 
				<p>Your OTP Code for this transaction is <strong>$otp_code</strong></p>
				<p>Like us On Facebook</p>
				<p>http://fb.me/Mr.Rahul.Negi/</p>
	</div>			
</body>
</html>